...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class FeatureSliderController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.v2 = "One cikan gorseler";
            ViewBag.v3 = "Slider One cikan gorsel listesi";
            ViewBag.vO = "One cikan Slider islemleri";
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                var values = JsonConvert.DeserializeObject<List<ResultFeatureSliderDto>>(jsonData);  // listde edende Desarilize 
        ...
        public async Task<IActionResult> CreateFeatureSlider(CreateFeatureSliderDto createFeatureSliderDto)
        {
            ...
            var jsonData = JsonConvert.SerializeObject(createFeatureSliderDto); // ekleyende serialize 
