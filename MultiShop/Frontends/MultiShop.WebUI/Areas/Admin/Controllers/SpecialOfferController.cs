...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class SpecialOfferController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.v0 = "Ozel teklif islemleri İşlemleri";
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                var values = JsonConvert.DeserializeObject<List<ResultSpecialOfferDto>>(jsonData);  // listde edende Desarilize 
        ...
        public async Task<IActionResult> CreateSpecialOffer(CreateSpecialOfferDto createSpecialOfferDto)
        {
            ...
            var jsonData = JsonConvert.SerializeObject(createSpecialOfferDto); // ekleyende serialize 
